...
public class FileMapSetting extends AbstractMapSettingContainer<String, FileMapSetting.FileEntry> {
    ...
    public static class FileEntry extends AbstractMapSettingContainer.MapSettingEntry<String> {
        ...
        public FileEntry(int x, int y, int width, Font textRenderer, FileMapSetting parent, String key, String value) {
        ...
        public void init() {
            super.init();
            int w = width - height;
            addDrawableChild(new Button(x + w / 2, y, w / 2, height, textRenderer, 0, 0xFF000000, 0x7FFFFFFF, 0xFFFFFFFF, Component.literal(value), (btn) -> {
