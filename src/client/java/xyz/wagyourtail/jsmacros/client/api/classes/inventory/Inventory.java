...
public class Inventory<T extends AbstractContainerScreen<?>> {
    ...
    public Inventory<T> click(int slot, int mousebutton) {
        ...
        man.handleContainerInput(syncId, slot, mousebutton, act, player);
        return this;
    }
    ...
    public Inventory<T> dragClick(int[] slots, int mousebutton) {
        ...
        man.handleContainerInput(syncId, -999, mousebutton - 1, ContainerInput.QUICK_CRAFT, player); // start drag click
        for (int i : slots) {
            man.handleContainerInput(syncId, i, mousebutton, ContainerInput.QUICK_CRAFT, player);
        }
        man.handleContainerInput(syncId, -999, mousebutton + 1, ContainerInput.QUICK_CRAFT, player);
        return this;
    }
    ...
    public Inventory<T> dropSlot(int slot) {
        man.handleContainerInput(syncId, slot, 0, ContainerInput.THROW, player);
        return this;
    }
    ...
    public Inventory<T> dropSlot(int slot, boolean stack) {
        man.handleContainerInput(syncId, slot, stack ? 1 : 0, ContainerInput.THROW, player);
        return this;
    }
    ...
    public Inventory<T> closeAndDrop() {
        ...
        if (!held.isEmpty()) {
            man.handleContainerInput(syncId, -999, 0, ContainerInput.PICKUP, player);
        }
        close();
        return this;
    }
    ...
    public Inventory<T> quick(int slot) {
        man.handleContainerInput(syncId, slot, 0, ContainerInput.QUICK_MOVE, player);
        return this;
    }
    ...
    public int quickAll(int slot, int button) {
        ...
        for (Slot slot2 : handler.slots) {
            if (slot2 != null
                ...
                man.handleContainerInput(syncId, slot2.index, button, ContainerInput.QUICK_MOVE, player);
            }
        }
        return count;
    }
    ...
    public Inventory<T> split(int slot1, int slot2) throws Exception {
        ...
        man.handleContainerInput(syncId, slot1, 1, ContainerInput.PICKUP, player);
        man.handleContainerInput(syncId, slot2, 0, ContainerInput.PICKUP, player);
        return this;
    }
    ...
    public Inventory<T> grabAll(int slot) {
        man.handleContainerInput(syncId, slot, 0, ContainerInput.PICKUP, player);
        man.handleContainerInput(syncId, slot, 0, ContainerInput.PICKUP_ALL, player);
        return this;
    }
    ...
    public Inventory<T> swap(int slot1, int slot2) {
        ...
        if (!is1) {
            man.handleContainerInput(syncId, slot1, 0, ContainerInput.PICKUP, player);
        }
        man.handleContainerInput(syncId, slot2, 0, ContainerInput.PICKUP, player);
        if (!is2) {
            man.handleContainerInput(syncId, slot1, 0, ContainerInput.PICKUP, player);
    ...
    public Inventory<T> swapHotbar(int slot, int hotbarSlot) {
        ...
        man.handleContainerInput(syncId, slot, hotbarSlot, ContainerInput.SWAP, player);
        return this;
    }
