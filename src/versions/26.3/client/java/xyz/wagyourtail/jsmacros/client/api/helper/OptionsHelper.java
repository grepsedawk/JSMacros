...
public class OptionsHelper extends BaseHelper<Options> {
    ...
    public OptionsHelper setWidth(int w) {
        ...
        win.setWindowed(w, win.getScreenHeight());
        return this;
    }
    ...
    public OptionsHelper setHeight(int h) {
        Window win = mc.getWindow();
        win.setWindowed(win.getScreenWidth(), h);
        return this;
    }
    ...
    public class ControlOptionsHelper {
        ...
        /**
         * Minecraft 26.3 uses SDL relative mouse mode while the pointer is captured. SDL has no
         * separate raw-mouse option, so this is always enabled.
         *
         * @return {@code true}
         * @since 1.8.4
         */
        ...
        /**
         * SDL has no raw-mouse option in Minecraft 26.3, so {@code val} has no effect.
         *
         * @param val ignored
         * @return self for chaining
         * @since 1.8.4
