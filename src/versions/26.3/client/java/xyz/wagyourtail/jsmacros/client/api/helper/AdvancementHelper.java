...
public class AdvancementHelper extends BaseHelper<AdvancementNode> {
    ...
    public String[] getLoot() {
        return base.advancement().rewards().loot().stream().map(e -> e.unwrapKey().orElseThrow().identifier().toString()).toArray(String[]::new);
    }
    ...
    public String[] getRecipes() {
        return base.advancement().rewards().recipes().stream().map(ResourceKey::identifier).map(Identifier::toString).toArray(String[]::new);
    }
