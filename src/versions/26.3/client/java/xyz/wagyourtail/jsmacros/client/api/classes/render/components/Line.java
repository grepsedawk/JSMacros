...
public class Line implements RenderElement, Alignable<Line> {
    private static final RenderPipeline LINES_SEE_THROUGH = RenderPipeline.builder()
            ...
            .withLocation("pipeline/jsmacros/lines_see_through")
            .build();
    private static final RenderType LINES_SEE_THROUGH_TYPE = RenderType.create(
            "jsmacros_lines_see_through",
            RenderSetup.builder(LINES_SEE_THROUGH).createRenderSetup());
    ...
    public void render3D(PoseStack matrixStack, int light, boolean seeThrough, SubmitNodeCollector collector, float delta) {
        ...
        RenderType lineLayer = seeThrough ? LINES_SEE_THROUGH_TYPE : RenderTypes.lines();
