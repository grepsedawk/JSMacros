...
public class AboutOverlay extends OverlayContainer {
    ...
    public void init() {
        ...
        this.addDrawableChild(new Button(x + 2, y + height - 14, w / 3, 12, textRenderer, 0, 0x7FFFFFFF, 0x7FFFFFFF, 0xFFFFFFFF, Component.literal("Website"), (btn) -> Blaze3D.openUri(java.net.URI.create("https://jsmacros.wagyourtail.xyz"))));

        this.addDrawableChild(new Button(x + w / 3 + 2, y + height - 14, w / 3, 12, textRenderer, 0, 0x7FFFFFFF, 0x7FFFFFFF, 0xFFFFFFFF, Component.literal("Discord"), (btn) -> Blaze3D.openUri(java.net.URI.create("https://discord.gg/P6W58J8"))));

        this.addDrawableChild(new Button(x + w * 2 / 3 + 2, y + height - 14, w / 3, 12, textRenderer, 0, 0x7FFFFFFF, 0x7FFFFFFF, 0xFFFFFFFF, Component.literal("CurseForge"), (btn) -> Blaze3D.openUri(java.net.URI.create("https://www.curseforge.com/minecraft/mc-mods/jsmacros"))));
