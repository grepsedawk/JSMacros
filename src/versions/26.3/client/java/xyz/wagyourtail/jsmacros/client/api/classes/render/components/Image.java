...
public class Image implements RenderElement, Alignable<Image> {
    ...
    private static final RenderPipeline ENTITY_TRANSLUCENT_SEE_THROUGH = RenderPipeline.builder(RenderPipelines.ENTITY_SNIPPET)
            ...
            .withCull(false)
            .build();
    private static final RenderPipeline ENTITY_TRANSLUCENT_FULL_BRIGHT = RenderPipeline.builder(RenderPipelines.ENTITY_SNIPPET)
            .withLocation("pipeline/jsmacros/entity_translucent_full_bright")
            .withShaderDefine("ALPHA_CUTOUT", 0.1f)
            .withShaderDefine("NO_CARDINAL_LIGHTING")
            .withBindGroupLayout(BindGroupLayouts.SAMPLER1)
            .withColorTargetState(new ColorTargetState(BlendFunction.TRANSLUCENT))
    ...
    private static final Map<Identifier, RenderType> ENTITY_TRANSLUCENT_FULL_BRIGHT_TYPES = new ConcurrentHashMap<>();
    ...
    public void render3D(PoseStack matrixStack, int light, boolean seeThrough, SubmitNodeCollector collector, float delta) {
        ...
        RenderType layer = seeThrough
                ...
                RenderSetup.builder(ENTITY_TRANSLUCENT_SEE_THROUGH)
                        ...
                        .useOverlay()
                        .createRenderSetup()))
                : ENTITY_TRANSLUCENT_FULL_BRIGHT_TYPES.computeIfAbsent(imageid, textureId -> RenderType.create(
                "jsmacros_entity_translucent_full_bright_" + textureId,
                RenderSetup.builder(ENTITY_TRANSLUCENT_FULL_BRIGHT)
                        .withTexture("Sampler0", textureId)
                        .useLightmap()
                        .useOverlay()
                        .createRenderSetup()));
