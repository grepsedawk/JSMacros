...
public class FurnaceInventory extends RecipeInventory<AbstractFurnaceScreen<?>> {
     ...
     * @throws UnsupportedOperationException because Minecraft 26.3 resolves fuel durations from
     *                                       item components in a server context and does not
     *                                       synchronize a fuel-value map to the client.
     * @since 1.8.4
     */
    public Map<String, Integer> getFuelValues() {
        throw new UnsupportedOperationException("Minecraft 26.3 does not synchronize fuel burn times to the client.");
    }
