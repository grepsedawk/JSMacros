...
public class ColorMapSetting extends AbstractMapSettingContainer<short[], ColorMapSetting.ColorEntry> {
    ...
    public static class ColorEntry extends AbstractMapSettingContainer.MapSettingEntry<short[]> {
        ...
        public void init() {
            super.init();
            int w = width - height;
            this.addRenderableWidget(new AnnotatedCheckBox(x + w / 2, y, w / 2, height, textRenderer, convertColorToInt(value), 0xFF000000, 0x7FFFFFFF, 0xFFFFFFFF, Component.literal(convertColorToString(value)), true, (btn) -> {
